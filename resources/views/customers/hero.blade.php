        ...
        <div class="hero-card">
            <div class="hero-card-01">
                <div class="hero-card-details">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-gem"
                         viewBox="0 0 16 16">
                        <path
                ...
                <div class="hero-card-details">
                    <svg style="width: 50%; height: 35%" id="Layer_1" data-name="Layer 1"
                         xmlns="http://www.w3.org/2000/svg" viewBox="0 0 441.2 300">
                        <defs>
                            <style>.cls-1, .cls-2 {
                                    fill: #1d1d1b;
                                }
