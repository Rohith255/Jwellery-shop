<div class="hero-img">
    <img src="https://images.unsplash.com/photo-1626784215013-13322cb0e471?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8Z29sZCUyMGpld2VsbGVyeXxlbnwwfHwwfHw%3D&w=1000&q=80" width="100%" height="85%">
    <div class="hero-card">
        <div class="hero-card-01">
            ...
            <div class="hero-card-details" style="border: none">
...
<div class="category">
    ...
    <div class="category-card-01">
        <a href="{{route('customer.products',1)}}" style="text-decoration: none">
            <div class="category-card">
                <img src="https://images.unsplash.com/photo-1622398925373-3f91b1e275f5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=874&q=80" width="100%" height="82%">
                <p>Ring</p>
            </div>
        </a>
    ...
    <div class="category-card-01">
        ...
        <a href="{{route('customer.products',2)}}" style="text-decoration: none">
            <div class="category-card">
                <img src="https://images.unsplash.com/photo-1606293926249-ed22e446d476?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8YmFuZ2xlc3xlbnwwfDB8MHx8&auto=format&fit=crop&w=500&q=60" width="100%" height="82%">
                <p>Bangles</p>
            </div>
        </a>
    </div>
