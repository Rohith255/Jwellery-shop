...
<div style="width: 100%;height: 27vh;position: fixed;background-color: white;box-shadow: rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px;">
    ...
    <div class="navbar">
        ...
        <div class="navbar-search">
            <form id="form">
                <input type="text" id="search-input" name="input_search" placeholder="search">
            </form>
                ...
                $.ajax({
                    ...
                    success:function (data){
                        ...
                        for (let i=0;i<data.length;i++){
                            searchResult+=`<div><a href="view-product/`+data[i].id+`">`+data[i].product_name+`</a><br></div>`
                        }
